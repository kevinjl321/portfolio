...
export class Contact extends Component {
    render() {
        return (
            <section id="contact" className="flex flex-col max-w-md px-6 py-12 mx-auto sm:px-10 sp:px-10 md:px-8 sm:max-w-2xl md:max-w-3xl lg:max-w-5xl sm:py-20 md:py-24 lg:py-32">
                ...
                <form name="contact" action="https://getform.io/f/1e434e35-6f32-4395-b8e1-d81358e8fb35" method="POST">
                    ...
                    <div className="flex justify-center">
                        <button
                            type="submit"
                            className="special px-12 py-2 bg-gray-900 mt-6 text-gray-300 font-bold text-center border-2 border-gray-200 transition duration-500 ease-in-out hover:bg-purple-300 hover:text-gray-900 hover:border-gray-900 text-xl lowercase rounded-full cursor-pointer font-header md:text-1xl"
