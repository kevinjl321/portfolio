            ...
            <section className="flex flex-wrap max-w-md px-6 py-8 mx-auto sm:max-w-xl md:max-w-4xl lg:max-w-5xl md:py-24 lg:py-40">
                ...
                <div className="flex items-center mt-6 md:w-2/3 md:mt-0 md:pl-6 lg:pl-6">
                    <div className="flex flex-col items-center text-primary dark:text-secondary md:items-start">
                        <h2 className="special mb-4 font-bold text-purple-300 leading-tight text-center text-5xl md:text-left sm:text-1xl md:text-5xl lg:text-5xl">
                        ...
                        Senior at San Marino High School who is passionate in all things revolving around the real world applications of computer science. Welcome to my portfolio!
                        </h3>
                        <div className="flex flex-row items-center">
                            ...
                            <a href = "#contact" className="special px-6 py-2 text-xl border-2 rounded-full text-gray-300 font-bold border-gray-200 text-center transition duration-500 ease-in-out hover:bg-purple-300 hover:text-gray-900 hover:border-gray-900 md:text-xl mt-4">contact</a>
                        </div>
                    </div>
                </div>
            </section>
